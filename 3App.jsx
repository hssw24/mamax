document.addEventListener("DOMContentLoaded", function () {
    ...
    function generateQuestion() {
        ...
        lastNumber = number;
        correctAnswer = number * 3; // Welche Zahlenreihe?
        questionCounts[number] = (questionCounts[number] || 0) + 1;
        question.textContent = `${number} × 3 = ?`; // Rechenaufgabe am Bildschirm
        generateAnswerButtons();
    }

    function generateAnswerButtons() {
        buttonsContainer.innerHTML = "";
        let answers = Array.from({ length: 10 }, (_, i) => (i + 1) * 3); // Mögliche Antworten 
